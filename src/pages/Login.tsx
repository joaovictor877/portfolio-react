  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        // Mantém o comportamento do projeto referência
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          >
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#00ffc8] to-[#00b8ff] flex items-center justify-center">
              <span className="text-slate-950 text-2xl font-bold">JV</span>
            </div>
            <span className="text-3xl font-bold bg-gradient-to-r from-[#00ffc8] to-[#00b8ff] text-transparent bg-clip-text">
              Portfólio
            </span>
          </motion.div>
          ...
          <motion.h1
            ...
            className="text-4xl font-bold mb-2 bg-gradient-to-r from-[#00ffc8] to-[#00b8ff] text-transparent bg-clip-text"
          >
            Bem-vindo
          </motion.h1>
          <motion.p
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="username" className="text-[#00ffc8]">
                Usuário
              </Label>
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-11 bg-slate-950/50 border-slate-700 focus:border-[#00ffc8] focus:ring-[#00ffc8]/20 transition-all"
                  required
                />
              </div>
            </div>
            ...
            {/* Password */}
            <div className="space-y-2">
              <Label htmlFor="password" className="text-[#00ffc8]">
                Senha
              </Label>
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-11 pr-11 bg-slate-950/50 border-slate-700 focus:border-[#00ffc8] focus:ring-[#00ffc8]/20 transition-all"
                  required
                />
                <button
                  type="button"
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-[#00ffc8] to-[#00b8ff] hover:from-[#00e6b0] hover:to-[#00a0e6] text-slate-950 font-bold py-6 rounded-full transition-all hover:shadow-lg hover:shadow-[#00ffc8]/30 hover:-translate-y-0.5"
            >
              {isLoading ? (
        ...
        >
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-[#00ffc8] hover:text-[#00b8ff] transition-colors group"
          >
